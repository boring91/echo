        ...
        <div className="mx-auto w-full max-w-screen-md">
          ...
          <div className="mt-8 rounded-lg border bg-background">
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="px-5 py-4 font-medium">Name</TableHead>
                  <TableHead className="px-5 py-4 font-medium">Type</TableHead>
                  <TableHead className="px-5 py-4 font-medium">Size</TableHead>
